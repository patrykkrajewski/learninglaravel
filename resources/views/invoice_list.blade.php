        ...
        <div class="justify-content-center w-75 container">
            <table class="table text-white text-center rounded" style="background-color: #1E2F47;">
                ...
                <tr style="background-color: #111E2B;" class="text-white">
                    ...
                    <th scope="col">
                        <a href="{{ route('invoices.index', ['sortBy' => 'invoice_date', 'sortDirection' => ($sortBy == 'invoice_date' && $sortDirection == 'asc') ? 'desc' : 'asc']) }}"
                           class="text-decoration-none text-reset">
                ...
                @forelse($invoices as $invoice)
                    <tr class="{{ $invoice->quantity == 0 ? 'bg-secondary' : '' }}">
                        ...
                        <td>
                            ...
                            <div class="d-flex justify-content-start text-center">
                                <a href="" class="btn btn-secondary border" data-toggle="modal" data-target="#move-modal-{{ $invoice->id }}">
                ...
                @empty
                    <tr>
                        <td colspan="10" class="text-center">Brak faktur do wyświetlenia.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
